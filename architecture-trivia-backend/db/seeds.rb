...
wash_DC = Question.create(correct_answer: "Washington, D.C., USA", answer1: "Berlin, Germany", answer2: "Seattle, WA, USA", answer3: "Dublin, Ireland", img: "file:///Users/flatriron/Documents/GitHub/Project/Mod 3/fewpjs-project-mode-guidelines/architecture-trivia-backend/images/PP_march_4.JPG", name: "U.S. Capitol") 
...
istanbul = Question.create(img: "file:///Users/flatriron/Documents/GitHub/Project/Mod 3/fewpjs-project-mode-guidelines/architecture-trivia-backend/assets/images/mosque_instanbul.jpg", name: "Hagia Sophia", correct_answer: "Istanbul, Turkey", answer1: "Havana, Cuba", answer2: "Djenne, Mali", answer3: "Kolkata, India")
manchu_pichu = Question.create(img: "file:///Users/flatriron/Documents/GitHub/Project/Mod 3/fewpjs-project-mode-guidelines/architecture-trivia-backend/assets/images/ManchuPichu.jpg", name: "Machu Picchu", correct_answer: "Cusco, Peru", answer1: "Djenne, Mali", answer2: "Buenos Aires, Argentina", answer3: "Angkor Wat, Cambodia")
